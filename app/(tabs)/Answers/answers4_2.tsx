  ...
  return (
      ...
      <ScrollView style={styles.background}>
          ...
          <View style={styles.TextSection}>
            ...
            <View style={styles.TextSection}>
              ...
              <Text style={styles.TextParagraph}>
                ...
                The public method "getInstance()" acts as a constructor. This is a static method, denoted by the underline, allowing any class in the system to call it when uninstantiated.{"\n"}
                When called, it will either return a stored instance, or create and store one if none exists. This lets the singleton decide how many instances there are - as the static method controls this.{"\n"}{"\n"}



                The "instance" variable is private, and stores a BooksDatabase. This is the global instance provided by the singleton! {"\n"}

                The "path" variable is simply a private string. It could be public, but this might help us protect from other methods copying the location and opening a new connection.
                {"\n"}{"\n"}
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.buttonHelp} onPress={ () => {navigation.navigate('', {number: 0, name: "amongus"});}}>
